...
#import "SuturdayViewController.h"

@interface SuturdayViewController ()

@end

@implementation SuturdayViewController
...
- (void)viewDidLoad
{
    ...
    satDropdown.frame=CGRectMake(0,-18,320,76);
}
...
- (IBAction)satDropdown:(id)sender {
    if (drawer1 == 0) {
        ...
        satDropdown.frame = CGRectMake(0, 70, 320, 76);
        
        
        [self.view bringSubviewToFront:(scrollView)];
        [self.view bringSubviewToFront:(satDropdown)];
